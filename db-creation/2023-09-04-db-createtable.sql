...
CREATE DATABASE IF NOT EXISTS `forum_dv` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `forum_dv`;
...
-- Listage des données de la table forum_dv.category : ~4 rows (environ)
...
-- Listage des données de la table forum_dv.media : ~3 rows (environ)
...
-- Listage des données de la table forum_dv.post : ~0 rows (environ)
...
-- Listage des données de la table forum_dv.topic : ~3 rows (environ)
...
INSERT INTO `user` (`id_user`, `pseudo`, `password`, `email`, `registrationDate`, `banned`, `role`) VALUES
	(1, 'test', 'test', 'test@test.fr', '2023-08-30 16:27:15', 0, NULL),
	(2, 'test2', 'test2', 'test2@test.fr', '2023-08-30 16:42:14', 0, NULL);
