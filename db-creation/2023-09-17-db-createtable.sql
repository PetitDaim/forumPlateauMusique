...
INSERT INTO `user` (`id_user`, `pseudo`, `password`, `email`, `avatar`, `registrationDate`, `banned`, `role`) VALUES
	(12, 'Denis Balades', '$2y$10$k1fUN9p1Uis.ncMExRd/2e3YYjJI/ops7UzM94oKPi3M8PZDWUOsy', 'villaumedenis@wanadoo.fr', './img/Users/12.jpg', '2023-09-05 11:51:33', 0, '["ROLE_USER"]'),
