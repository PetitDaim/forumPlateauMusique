<?php
    ...
    define('BASE_DIR', "..".DS); // pour se simplifier la vie
    define('VIEW_DIR', BASE_DIR."view".DS);     //le chemin où se trouvent les vues
    define('PUBLIC_DIR', ".".DS);     //le chemin où se trouvent les fichiers publics (CSS, JS, IMG)
